...
def create_class(class_name, method_names):
    code = f'import {{ firstNonEmpty, safeArray, safeString, distanceToDoor, tileKey, formatRelativeTime, clampDistance }} from "./utils.js";\n\n'
...
create_class("AgentStateController", agent_methods)

all_extracted = set(agent_methods)
new_content = ""
prev_end = 0
