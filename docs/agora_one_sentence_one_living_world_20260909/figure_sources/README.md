...
The four box-and-arrow diagrams additionally run a text-boundary check during
generation. A build fails if a title or body label leaves its box or if the two
