...
def main():
    texts = [PAPER / "agora_one_sentence_one_living_world_20260923.tex", *sorted((PAPER / "sections").rglob("*.tex"))]
    ...
    log=(PAPER/'agora_one_sentence_one_living_world_20260923.log').read_text()
    ...
    print(f"Verified {len(keys)} cited references, {len(labels)} labels, {len(list((PAPER / 'figures').glob('*.pdf')))} figure assets, "
