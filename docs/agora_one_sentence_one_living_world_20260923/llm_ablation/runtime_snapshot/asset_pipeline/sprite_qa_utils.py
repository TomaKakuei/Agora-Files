...
DEFAULT_PROCESSING = {
    ...
    "qa_component_min_largest_ratio": 0.60,
...
def _merged_processing(processing: dict[str, Any] | None) -> dict[str, Any]:
    ...
    raw["target_frame_width"] = int(raw.get("target_frame_width", 64))
    raw["target_frame_height"] = int(raw.get("target_frame_height", 64))
    ...
    raw["qa_component_min_largest_ratio"] = float(raw.get("qa_component_min_largest_ratio", 0.60))
