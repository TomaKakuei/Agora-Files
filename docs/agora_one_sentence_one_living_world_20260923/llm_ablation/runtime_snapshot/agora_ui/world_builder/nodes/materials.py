...
def generate_materials_spec(
    ...
    visual_canon = (
        planner_spec.get("visual_canon", {})
        if isinstance(planner_spec.get("visual_canon", {}), dict)
        else {}
    )
    ...
    if is_panjiayuan:
        style_guidance = """
        This world explicitly depicts Panjiayuan's traditional Chinese antique market.
        - Prefer worn stone, old brick, timber, cloth, glass cases, and other materials justified by the named room.
        - Use Chinese-market visual cues only where they follow from the premise and shared Visual Canon.
        """
    elif is_modern:
        style_guidance = """
        ...
        style_guidance = """
        Derive all materials from this world's premise, room functions, and shared Visual Canon.
        - Do not import Chinese antique-market, modern optical-mall, medieval-guild, or cyberpunk materials unless the world explicitly calls for them.
        - Choose the closest available tile primitive, then use palette and showcase fields to preserve the world's own material language.
        """
