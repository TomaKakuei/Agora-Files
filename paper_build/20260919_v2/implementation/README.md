...
This repository is the full-stack implementation maintained on the internal
Agora 2.0 release line.
...
- Runtime Python defaults to the current interpreter and can be overridden with `AGORA_RUNTIME_PYTHON` or `AGORA_PYTHON_BIN`.
...
- [README For LLM.md](README%20For%20LLM.md)
  High-level implementation contract for future work.
- [SYNC_WITH_AGORA_C.md](SYNC_WITH_AGORA_C.md)
  Sync boundary and repo split policy.
- [MemoryFrontEnd.md](MemoryFrontEnd.md)
