#!/usr/bin/env python3
"""Render paper figures directly from the committed interaction metrics."""
...
OUT = ROOT / "docs" / "figures_20260803"
...
def tidal_runtime_capture():
    screenshot = Path("/tmp/agora_pixel_headless_26072403_7b8498dfd937386f.png")
    context_screenshot = Path("/tmp/agora_pixel_headless_26080406_56740f0cb7674520.png")
