...
Important implementation helpers live in [package_db.py](agora_ui/package_db.py).
...
FastAPI in [serve_macro_ui.py](macro_ui/serve_macro_ui.py) serves:
...
Live state is managed by `PixelLiveStore` in [live_world](agora_ui/live_world/).
...
- [WorldScene.js](frontend/src/WorldScene.js)
- [AgentManager.js](frontend/src/AgentManager.js)
