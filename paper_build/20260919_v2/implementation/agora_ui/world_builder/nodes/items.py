...
def generate_items_spec(
    ...
    Cover the causal system: include instruments that measure state variables, credentials or evidence that institutions recognize,
    scarce inputs that stakeholders depend on, and materials that can be transferred or consumed by open proposals.
    """
