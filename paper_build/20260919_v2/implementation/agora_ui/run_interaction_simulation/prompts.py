...
def _vertex_action_request(
    ...
    *,
    ...
    schema = {
        "route_id": "string, existing route_id or __propose__",
        ...
        "proposed_action": {
            "action_name": "string",
            "action_text": "specific intended action or utterance",
            "target_agent_id": "string",
            "rationale": "why this action fits the current world state",
            "target_response": "accept|reject|counter|not_required|unknown",
            "effects": [
                {
                    "kind": "speech|transfer|create_item|status",
                    ...
                    "content": "exact speech content when kind=speech",
                }
            ],
        },
    }
    ...
    prompt = (
        ...
        "Use an existing route_id when it expresses the intended action. When it does not, return route_id='__propose__' and a concrete proposed_action. "
        "Open proposals may use different words for different people, suggest deliberately unequal trades, create a bounded new object, or combine effects. "
        "Do not assume approval: the World Coordinator will check proximity, ownership, consent, conservation, world rules, and effect bounds.\n"
