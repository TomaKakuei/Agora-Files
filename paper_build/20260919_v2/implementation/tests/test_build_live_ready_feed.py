        ...
        with TemporaryDirectory() as tmp_dir:
            ...
            ready_assets = [
                ...
                },
                {
                    ...
                    "atlas_url": "./assets/generated/agent_002/flux_rerun_01/agent_atlas.png",
                    "json_url": "./assets/generated/agent_002/flux_rerun_01/agent_atlas.json",
                    "revision": "flux_rerun_01",
                    "world_id": "demo_world",
                    "world_name": "Demo World",
                    "world_revision": revision,
                    "default_animation": "idle_down",
            ...
            manifest = build_live_ready_feed._canonicalize_revision_manifest(
                ...
                generated_results=[{"agent_id": "agent_002", "revision": "flux_rerun_01"}],
                missing_agent_ids=[],
                world_id="demo_world",
                world_revision=revision,
            )
            ...
            self.assertEqual(manifest["agents"][1]["atlas_url"], "./assets/generated/agent_002/flux_rerun_01/agent_atlas.png")
            ...
            self.assertEqual(manifest_payload["agents"][1]["resolved_revision"], "flux_rerun_01")
